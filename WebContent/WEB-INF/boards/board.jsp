...
<body>
	<div id="wrapper" class="container">
        ...
        <c:forEach var="tmp" items="${result}">
	        <div id="articleLine" class="row">
	              <div class="col-lg-1 col-md-1 col-sm-3 col-3 p-0">${tmp.textNo}</div>
	              <div class="col-lg-5 col-md-5 col-sm-8 col-8 p-0">
	              <a class="title" href="reading.board?textNo=${tmp.textNo}">${tmp.title}</a></div>
                ...
                <nav aria-label="Page navigation example">
                    <ul class="pagination pagination-sm justify-content-center m-2">
                        <c:if test="${pageNavi[0] == 0}">
	                        <li class="page-item"><a class="page-link" href="textList.board?currentPage=${pageNavi[1]-1}" aria-label="Previous"><span aria-hidden="true">&laquo;</span></a></li>
                        </c:if>
                        <c:if test="${currentPage > 1}">
		                    <li class="page-item"><a class="page-link" href="textList.board?currentPage=${currentPage-1}" aria-label="Previous"><span aria-hidden="true">&lt;</span></a></li>
	                    </c:if>
                        <c:forEach var="navi" items="${pageNavi}" begin="1" end="10">
	                        <c:if test="${navi > 0}">
	                        <li class="page-item"><a class="page-link" href="textList.board?currentPage=${navi}">${navi}</a></li>
	                        </c:if>
                    	</c:forEach>
                        ...
                        <c:if test="${pageNavi[11] == 0}">
	                        <li class="page-item"><a class="page-link" href="textList.board?currentPage=${pageNavi[10]+1}" aria-label="Next"><span aria-hidden="true">&raquo;</span></a></li>
                        </c:if>
                    </ul>
