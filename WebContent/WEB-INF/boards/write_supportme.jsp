...
<body>
	...
	<hr>
<div class="wrapper">
	<form action="supportme.board" method="post" enctype="multipart/form-data" id="photo">
		<div class="form-group">
				후원 게시판에 표시될 사진 파일을 첨부해 주세요.
				<input type="file" class="photo" name="file" value="사진 첨부">
		</div>
	</form>		
	<form action="supportme.board" method="post" id="except_photo">	
			<div class="form-group">
			<input type="text" class="form-control" id="title"
						name="title" aria-describedby="" placeholder="제목을 입력해 주세요." required>
			</div>
			<div class="form-group">
			...
			<div class="form-group">
				모금 마감날짜를 입력해 주세요.(모금은 후원글이 등록된 시점부터 시작됩니다.)
				<input type="date" class="form-control" id="start_period"
						name="end_period" aria-describedby="" placeholder="" required>
			</div>
			<div class="form-group">
				후원받으실 계좌의 은행명과 계좌번호를 입력해 주세요.
				<input type="text" class="form-control" id="bank"
						name="bank" aria-describedby="" placeholder="은행명 예)신한" required>
				<input type="text" class="form-control" id="account"
						name="account" aria-describedby="" placeholder="계좌번호 '-' 제외하고 입력" required>
			</div>	
	</form>
</div>	
	<div id="wrapper" class="container p-1">
        <form id="article" action="supportme.board" method="post">
	        <div class="row">
             ...
             <div id="footer" class="row">
	        	<div class="col-12">    
		            <div class="btns">
	                    <input id="sendit" class="btn btn-sm btn-outline-primary" type="button" value="등록">
		            </div>
		            <div class="btns">
